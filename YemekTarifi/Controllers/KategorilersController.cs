...
namespace YemekTarifi.Controllers
{
    public class KategorilersController : Controller
    {
        ...
        public KategorilersController(YemekTarifiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Kategorilers != null ? 
                          ...
                          Problem("Entity set 'YemekTarifiContext.Kategorilers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("KategoriId,Ad,Adet,Resim")] Kategoriler kategoriler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("KategoriId,Ad,Adet,Resim")] Kategoriler kategoriler)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'YemekTarifiContext.Kategorilers'  is null.");
            }
            var kategoriler = await _context.Kategorilers.FindAsync(id);
            if (kategoriler != null)
            {
